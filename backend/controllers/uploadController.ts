...
export const createRequest = async (req: Request, res: Response) => {
    try {
        const { uploaderEmail, requestedFileTypes, expirationDays, allowMultiple } = req.body;
        ...
        await gcNotifyService.sendUploadRequestEmail(uploaderEmail, requestorEmail, uploadLink, autoGeneratedSecret, allowMultiple === true, entity.caseNumber);
