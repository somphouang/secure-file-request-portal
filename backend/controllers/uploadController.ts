...
export const createRequest = async (req: Request, res: Response) => {
    try {
        ...
        // Send email
        await gcNotifyService.sendUploadRequestEmail(uploaderEmail, requestorEmail, uploadLink, secret, allowMultiple === true, entity.caseNumber);
...
export const inviteDownloaderToShare = async (req: Request, res: Response) => {
    try {
        ...
        await gcNotifyService.sendDownloadRequestEmail(downloaderEmail, requestorEmail, downloadLink, downloadPasscode, share.caseNumber);
