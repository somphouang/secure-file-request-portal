...
> - **Frontend**: Vite with React and Vanilla CSS (designed to look modern, dynamic, and premium).
> - **Backend**: Node.js with Express.js.
> - **Database**: Azure Table Storage (for fast, NoSQL tracking of requests and hashes).
...
> - **Scanning**: Assemblyline API integration to scan uploaded files before making them available for download.
...
- **Table**: `UploadRequests`
  ...
  - `Status`: String (Pending -> Uploaded -> Scanning -> Clean | Malicious)
  - `BlobUri`: String
  - `FileHash`: String
  - `CreatedAt`: DateTime
  - `ExpiresAt`: DateTime
